...
class TransferAdapter {
  constructor(transferSystem) {
    this.transferSystem = new WalletTransfer();
  }
  initiateTransfer(amount) {
    this.calculatedAmount = this.calculateFee(amount);
    this.transferSystem.processTransfer(this.calculatedAmount);
  }
...
const purchase3 = new WalletTransfer();
purchase3.processTransfer(10);

const purchase4 = new TransferAdapter();
purchase4.initiateTransfer(10);
